  ...
  return (
    <div className="app-container">
      ...
      {loading && <p>Please wait...</p>}
        ...
        {/* <img src="images/2.png" height={100} width={150} onMouseEnter={()=> downloadQR("celinaa")}/> */}
        <div>
            ...
            {/* <button className="generate-button" onClick={()=> alert("Hi")}>Generate QR Code</button> */}
            <button className="download-button" onClick={downloadQR} >Download QR Code</button>
            {/* <button className="download-button" onClick={()=> downloadQR("celinaa")}>Download QR Code</button> */}
        </div>
        <p className='footer'>
          Designed By <a>Celinaa</a>
           </p>
    </div>
  )
}
